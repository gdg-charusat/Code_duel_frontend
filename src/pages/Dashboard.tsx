...
const Dashboard: React.FC = () => {
  ...
  const isLoading =
    statsLoading || activityLoading || chartLoading || challengesLoading;
  ...
  return (
    <Layout>
      <AsyncStateWrapper
        ...
        emptyDescription="Create or join a challenge to start competing."
        errorIcon={Zap}
      >
          ...
          <div className="space-y-4">
            ...
            {challenges.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Create or join a challenge to start competing with others."
              />
            )}
          </div>
        </div>
